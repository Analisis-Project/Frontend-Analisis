    ...
    <div class="w-full h-full flex items-center justify-center">
        <div class="flex flex-col text-white">
            ...
            <form @submit.prevent="submitForm" class="mb-10">
                ...
                <div v-if="graphType === 'custom'" class="mb-10">
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <input type="checkbox" id="grafocompleto" name="grafocompleto" value="grafocompleto" class="hidden peer"
                            required />
                    ...
                    <div class="mb-5">
                        <input type="checkbox" id="grafoconexo" name="grafoconexo" value="grafoconexo" class="hidden peer"
                            required />
                    ...
                    <div class="mb-5">
                        <input type="checkbox" id="grafoponderado" name="grafoponderado" value="grafoponderado" class="hidden peer"
                            required />
                    ...
                    <div class="mb-5">
                        <input type="checkbox" id="grafodirigido" name="grafodirigido" value="grafodirigido" class="hidden peer"
                            required />
